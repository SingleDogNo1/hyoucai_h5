...
export default {
      ...
      commonQuestions: [
        {
          ...
          flag_min: true,
          flag_plus: false,
          answer: '<span>目前汇通金融旗下网贷平台汇有财投资服务需要使用可用余额进行交易，您需要先把银行卡资金充值到可用余额，才可以进行投资。</span>'
        },
        {
        ...
        },
        {
          ...
          flag_plus: true,
          answer:
            '<span>半月嗨月月盈吉季盈禄陆丰暂不支持中途提前退出，投资期限到期后本金及最后一期利息会自动打入汇有财账户余额，您可以选择提现到银行卡或继续投资。</span>'
        },
        {
  ...
  computed: {
    style() {
      const headerHeight = this.mobile ? '0' : '0.44rem'
      return {
