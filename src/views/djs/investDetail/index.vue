  ...
  <div class="invest-detail">
      ...
      <div>
        <section class="pro-info">
          <div class="pro-info-head">
            ...
            <div class="item-r" v-if="parseInt(investDetail.isSurplusShow) == 1 && parseFloat(investDetail.surplusAmount) >10000">
              <span class="overplus">剩余可投</span><br />
              <span class="over_amount">{{(Math.round(investDetail.surplusAmount)/10000).toFixed(2) }}万</span>
            </div>
            <div class="item-r" v-else-if="parseInt(investDetail.isSurplusShow) == 1 && parseFloat(investDetail.surplusAmount) < 10000">
              <span class="overplus">剩余可投</span><br />
              <span class="over_amount">{{investDetail.surplusAmount }}元</span>
            </div>
          </div>
    ...
    <section class="to-lend">
      <div class="lend_btns" @click="invest">
        <p>授权出借</p>
        <span v-if="investDetail.isSurplusShow == 1 && parseFloat(investDetail.surplusAmount) >10000">剩余可投{{(Math.round(investDetail.surplusAmount)/10000).toFixed(2) }}万</span>
